...
Platform development of 5G and 6G...
\end{itemize}
}
...
factory, to save time and money.
    ...
    \item Development of radio software drivers for the Radio SW platforms and
          ...
          modularizing parts of the Radio SW code, introducing Git, Gerrit,
          Jenkins, BitBake and Autotools.
    ...
    \item Act as a technical Scrum/Kanban Master to lead and coach a
          ...
          meetings, sprint rerospective meetings, keep statistics of flow,i
          eliminate waste and help Product Owner.
    \end{itemize}
}

\cventry{2008--2011}{Software Developer}{SAAB Combitech}{Stockholm}{Sweden}{
My career started at SAAB Combitech as a consultant for Ericsson AB Linux
Center in Älvsjö and Telefonplon. There, I developed a test framework in Perl
which is used to run automated test cases. The test cases was written in
Tcl/Expect but the framework can also execute test cases in Perl or Bash and
also support NetConf. The test framework became a separate product and was used
to test different Linux embedded operating systems by many Ericsson products at
the department. I continued in the same department but as a designer where I
began to develop Linux kernel patches and pushed upstream to Linus Torvalds.
    \begin{itemize}
...
another PhD student, we published a paper and the whole experience abroad gave
me new friends for life, deepened my analytical thinking and broaden my
knowledge in research and software development.
    \begin{itemize}
...
%\citem{Committee Member}, Lule\aa \ University Academic Computer Society (2005 -- 2006)
%\citem{Treasurer}, Lule\aa \ University Academic Computer Society (2004 -- 2005)
%\begin{itemize}
