...
% Programming
\cvskillentry*{Programming Languages:}{5}{Ansible}{3}{I use Ansible, Jinja2, YAML and Redfish for zero-touch automation.}
\cvskillentry{}{3}{Assembler}{1}{Mips32 course at university.}
...
% Software Tools
\cvskillentry*{Tools:}{5}{Buildroot}{3}{Used to build embedded Linux OS.}
