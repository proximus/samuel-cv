...
%===============================================================================
\section{Experience}
\cventry{2023-06-01 -- 2023-12-31}{Scrum Master and Embedded Developer}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
\item \textbf{\textit{Consultant at CrossControl AB - Uppsala}}\newline{}
Scrum Master for two Linux/Windows Embedded teams. Develop drivers and
application for products like X1200 and X900 the rest of the time.
    \begin{itemize}
    \item Drive team meetings and be responsible for the team and backlog.
          Create the backlogs for the different products and keep it up to date
          with sufficient quality. Create well documented tasks and assign
          tasks with optimized flow. Identify potential impediments and prevent
          them from happening.
...
Pre-development of firmware for algorithm control and functions in Micro
...
\cventry{2011--2016}{Scrum Master and Software Developer}{Ericsson AB}{Stockholm}{Sweden}{
Employed at Ericsson in Kista as a Scrum Master and Software Developer. I was
responsible for a team of 10 developers. In parallell, I also developed drivers
for the radio hardware units used in the Radio Base Station 6000 series. In
order to first boot and bring up the radio hardware, the different drivers for
the many components on the board needs to be working and configured correctly.
This is done by either creating the drivers from scratch using the components
data sheet and the boards circuit diagram or simply by adapting and reusing
existing drivers. In most cases we emulate the hardware first and then write
the drivers, before the physical boards arrive from the factory, to save time
and money.
    \begin{itemize}
