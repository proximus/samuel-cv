...
%===============================================================================
\section{Experience}
\cventry{2018 -- Ongoing}{Senior Research Software Engineer}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
...
prototypes. Responsible for the uppler layer baseband applications to run on a
...
\cvskillentry{}{3}{Listp/Scheme}{3}{Did the SICP course at University and to configure my Emacs editor.}
...
\cvskillentry{}{3}{Pascal}{4}{Self-taught Turbo Pascal as a child.}
...
\cvskillentry{}{4}{Yocto/BitBake/Poky}{3}{Used to build embedded Linux OS.}
