...
With over 15 years of experience spanning roles such as \textbf{Senior Linux
Embedded and Kernel Developer}, \textbf{Scrum Master}, \textbf{Product Owner},
and specialist in \textbf{System Integration}, \textbf{IT automation}, and
\textbf{Test Framework architecture}, I bring a strong leadership and technical
foundation. My proudest achievement was contributing to \textbf{NASA's
Ingenuity Mars Helicopter}, helping achieve the first powered, controlled
flight on another planet.
\newline
\newline
I take pride in being not only a skilled engineer but also a collaborative and
social team member who enjoys fostering a positive atmosphere while solving
complex challenges. As a natural problem solver, I approach every project with
curiosity and persistence, building trust through reliability, openness, and a
commitment to sharing knowledge with both colleagues and customers.
...
\section{Experience}
% 20240314 - 20260227
\cventry{Mar 14, 2024-- Mar 01, 2026 }{SW Developer, Scrum Master and Product Owner}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
\item \textbf{\textit{Consultant at Ericsson AB - Radio Software}}\newline{}
A two years contract at RadioSW RX/Uplink team. Balance three roles at the same
time as a Developer, Scrum Master and Product Owner for the Massive Mimo Granada
program and the BALI Project for Radio product AAS AIR 6494.
    \begin{itemize}
    \item Developer for the remaining time. Focusing on the Uplink/Rx part of
          the software consisting of drivers and test cases.
    \item Scrum master for the Uplink/Rx team. Drive Way of Working with daily
          stand-up, sprint review, retrospective, refinement and sprint planning.
    \item Product owner for the Uplink/Rx side of the product. Initial creator
          of the backlog for the whole RadioSW BALI project in Jira. Create,
          groom and plan the backlog for the team.
    \item Use tools like Yocto, Jira, Git, Gerrit, Jenkins, C/C++, Java and
        Neo-vim with AI (Codeium) integration.
    \end{itemize}
\end{itemize}
}
\bigskip
...
% 20230601 - 20231231
\cventry{Jun 01, 2023-- Dec 31, 2023 }{Embedded Developer and Scrum Master}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
\item \textbf{\textit{Consultant at CrossControl AB - Uppsala}}\newline{}
Scrum master and Linux Embedded Developer. Handle two scrum teams (one Windows
and one Linux team) and develop drivers and application for products like
CCPilot X1200 and X900. The CCpilot X1200 is an 12" display with laptop
performance for industrial vehicles designed to meet tough environmental
requirements. It supports modern, and next-generation, tools that can
seamlessly integrate multiple camera streams into your HMI system, enhancing
operator visibility and safety.
    ...
    \item Drive team meetings, daily stand-up, sprint review, retrospective,
          ...
          sufficient quality. Create well documented tasks and assign tasks
          with good flow.
    \item Develop Linux kernel drivers and in-house software to support
          lightsensor, EEPROM, automatic backlight, keypads, audio codec,
          PXE bootable installation images for customer and production, i2c
          communication and CAN-FD MCU.
    \item Use tools like Yocto, Devtool, Jira, Git, BitBucket, Jenkins and
          C/C++, python, bash and vim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
Predevelopment of firmware for algorithm control and functions in Micro
Controllers (also called Device Processors (DP) in Ericsson terms). With the
help of DPs, Power Amplifiers can be made efficient by reducing the distortion
created in their non-linear regions.
    \begin{itemize}
    \item Write in Matlab and C, Digital Pre-Distortion (DPD) software to
          increase the efficiency of Power Amplifiers.
    \item Use Xilinix SDK or Vitis IDE to implement and debug the FPGA and
          software load on the target.
    \end{itemize}
\end{itemize}
}
\bigskip
...
Platform research and development of 5G and 6G testbeds to field trial
prototypes. Responsible for the upper layer BaseBand applications to run on a
real-time OS by minimizing CPU jitter and NIC latency.
    \begin{itemize}
    ...
    \item Implement zero-touch automation using Ansible on Ericsson proprietary
          hardware and commercial off-the-shelf (COTS) hardware like SuperMicro,
          Dell PowerEdge machines that has BMC/IPMI/iDRAC and Mellanox SN4700
          400GbE switches with Cumulus. The automation conducts a full
          deployment of OS on multiple nodes in parallel and configures BIOS,
          LDAP, PTP, auto installs unattended Linux or Cumulus OS and sets up
          real-time OS  properties with low CPU jitter and low NIC latency.
    \end{itemize}
\end{itemize}
}
\bigskip
...
% 20161201 - 20180930
\cventry{Dec 01, 2016-- Sep 30, 2018 }{Senior Software Architect and Design}{Realtime Embedded AB}{Stockholm}{Sweden}{
\begin{itemize}
...
% 20110610 - 20161123
\cventry{Jun 10, 2011-- Nov 23, 2016 }{Software Developer and Scrum Master}{Ericsson AB}{Stockholm}{Sweden}{
Employed at Ericsson in Kista as a Software Developer and Scrum Master. I
...
factory, to save time and money.
    ...
    \item Act as a technical Scrum/Kanban Master to lead and coach a
          ...
          meetings, sprint retrospective meetings, keep statistics of flow,
...
% 20080825 - 20110609
\cventry{Aug 25, 2008-- Jun 09, 2011 }{Software Developer}{SAAB Combitech}{Stockholm}{Sweden}{
