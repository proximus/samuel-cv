...
%===============================================================================
\section{Om Mig}
Med över 15 års erfarenhet inom områden som \textbf{Senior Linux Embedded och
Kernelutvecklare}, \textbf{Scrum Master}, \textbf{Produktägare} samt specialist
i \textbf{systemintegration}, \textbf{IT-automation},
\textbf{testramverk-arkitektur} och \textbf{testfall}, kombinerar jag teknisk
expertis med starkt ledarskap. Ett av mina mest stolta bidrag var att medverka
i \textbf{NASA:s Ingenuity Mars-helikopter}, vilket möjliggjorde den första
kontrollerade motorflygningen på en annan planet.
\newline
\newline
Jag är en problemlösare som närmar mig varje utmaning med nyfikenhet och
uthållighet, och jag värdesätter samarbete och en positiv arbetsmiljö. Genom
...
Ett tvåårigt kontrakt inom RadioSW RX/Uplink-teamet, där jag balanserade tre
roller samtidigt: utvecklare, Scrum Master och Product Owner för Massive MIMO
Granada-programmet samt BALI-projektet för radioprodukten AAS AIR 6494.
    \begin{itemize}
    ...
    \item Productägare för Uplink/Rx-delen av produkten. Initial skapare av backloggen för hela RadioSW BALI-projektet i Jira. Skapa, förfina och planera backloggen för teamet.
...
Scrum master och Linux Embedded Utvecklare. Ansvarade för två Scrumteam (ett
...
förbättrar operatörens sikt och säkerhet.
    ...
    \item Utveckla Linux kernel drivrutiner och in-house mjukvara för att stödja ljussensorn, EEPROM, automatisk bakgrundsbelysning, knappsatser, audio codec, PXE bootable installationsavbilder för kund och produktion, I2C-kommunikation samt CAN-FD MCU.
...
Pre-development av firmware för algoritmstyrning och funktioner i
mikrokontrollers (även kallade Device Processors (DP) i Ericssons terminologi).
Med hjälp av DP:er kan Power Amplifiers (effektförstärkarna) göras mer
effektiva genom att minska den distorsion som uppstår i deras icke-linjära
områden. Resultatet av uppdraget används sen av framtida radio produkter inom
6G.
    \begin{itemize}
...
NIC-latens.
    ...
    \item Skapa och konfiguera realtids OS baserat på Ubuntu. Supporta avdelningen och se till att realtidsapplikationen för basbandet kan köra på OS:et med höga krav på låg CPU-jitter.
