...
%===============================================================================
\section{Om Mig}
Med över 15 års erfarenhet inom omr{\aa}den som \textbf{Senior Embedded Linux and Kernel Developer}, \textbf{Scrum Master}, \textbf{Produktägare} samt specialist
i \textbf{systemintegration}, \textbf{IT-automation},
\textbf{testramverk-arkitektur} och \textbf{testfall}, kombinerar jag teknisk
expertis med starkt ledarskap. Ett av de projekt jag är mest stolt över var
mitt bidrag till \textbf{NASA:s Ingenuity Mars-helikopter}, vilket möjliggjorde
den första kontrollerade motorflygningen på en annan planet.
\newline
\newline
...
\section{Erfarenhet}
% 20240314 - 20260227
\cventry{Mar 14, 2024-- Mar 01, 2026 }{Utvecklare, Scrum Master och Produktägare}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
...
6494.
    \begin{itemize}
    \item Utvecklare under återstående tid, med fokus på Uplink/Rx-delen av mjukvaran, bestående av drivrutiner och testfall.
    \item Scrum Master för Uplink/Rx-teamet. Driva arbetssättet (Way of Working) genom dagliga stand-ups, sprintgranskningar, retrospektiv, refinement och sprintplanering.
    ...
    \item Använda verktyg som Yocto, Jira, Git, Gerrit, Jenkins, C/C++, Java och NeoVim med AI-integration (Codeium).
    \end{itemize}
\end{itemize}
}
\bigskip
...
% 20230601 - 20231231
\cventry{Jun 01, 2023-- Dec 31, 2023 }{Embedded Developer och Scrum Master}{Saitama AB}{Stockholm}{Sweden}{
\begin{itemize}
\item \textbf{\textit{Konsult på CrossControl AB - Uppsala}}\newline{}
Scrum master och Embedded Linux-utvecklare. Ansvarade för två Scrumteam (ett
Windows-team och ett Linux-team) samt utvecklade drivrutiner och applikationer
för produkter som CCPilot X1200 och X900. CCPilot X1200 är en 12-tums display
med prestanda i nivå med en bärbar dator för industriella fordon, utformad för
att uppfylla krävande miljökrav. Den stöder moderna och nästa generations
verktyg som sömlöst kan integrera flera kameraflöden i ditt HMI-system, vilket
förbättrar operatörens sikt och säkerhet.
    \begin{itemize}
    ...
    \item Använda verktyg som Yocto, Devtool, Jira, Git, Bitbucket, Jenkins samt C/C++, Python, Bash och Vim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
% 20161201 - 20180930
\cventry{Dec 01, 2016-- Sep 30, 2018 }{Senior Software Architect och Designer}{Realtime Embedded AB}{Stockholm}{Sweden}{
\begin{itemize}
...
Utveckling av Linux-kärndrivrutiner för passerkontrollsystem E100
centralenhet bestående av MCU AT91SAM9x5-EK till Omnissystemet.
    \begin{itemize}
...
% 20110610 - 20161123
\cventry{Jun 10, 2011-- Nov 23, 2016 }{Software Developer och Scrum Master}{Ericsson AB}{Stockholm}{Sweden}{
Anställd på Ericsson i Kista som mjukvaruutvecklare och Scrum Master till Radio
Base Station 6000-serien. Utvecklad drivrutiner och simulatorn för
radiohårdvaran. För att spara tid och pengar så brukar vi emulera hårdvaran
först och därefter utveckla drivrutinerna tills de fysiska korten anländer från
fabriken.
    \begin{itemize}
...
Fast anställd som konsult på SAAB Combitech på uppdrag hos Ericsson AB Linux
Center i Älvsjö och Telefonplan. Där skapade jag ett testramverk i Perl som
används för att köra automatiserade testfall. Testfallen skrevs i Tcl/Expect,
men ramverket kunde även köra testfall i Perl, Bash och Python samt stödde
NetConf och YAML. Testramverket blev en egen produkt och användes för att testa
olika Linuxbaserade inbyggda operativsystem i många av Ericssons produkter inom
avdelningen. Jag fortsatte inom samma avdelning, men som designer, där jag
började utveckla Linux-kärnpatchar och bidrog med patchar upstream till
Linux-kärnan.
    \begin{itemize}
    \item Utveckla Linux-kärndrivrutiner och Linux-kärnpatchar till ECC (Error Detection and Correction) memory scrubbing. Detta hindrar datakorruption och systemkrascher orsakade av strålningsinducerade bitfel (t.ex. kosmisk strålning, elektriskt brus)
    \item Utveckla Ericssons Linuxdistribution kallad ENUX, som används för att köra en virtuell maskin som emulerar APZ Classic runtime-miljö för PLEX-baserade program såsom AXE.
    \item Designer och testare för andra plattformsprodukter inom Ericsson, såsom CPBS, GSDI och IS, som körs på GEP-korthårdvara.
    \item Utveckla testramverk och testfall för Ericssons OS produkter som Linux Open-source Telecom Cluster (LOTC) och SLES Virtual Platform (SVP) baserade på Xen.
    \item Support i kundforum för Open Multimedia Platform (OMP). Hantera och lösa felrapporter för samtliga produkter.
    \end{itemize}
}
\bigskip

\cventry{2006--2007}{Research Assistant}{University of Toronto}{Toronto}{Canada}{
Jag arbetade som forskningsassistent åt professor J. Christopher Beck vid
Department of Mechanical and Industrial Engineering. Min vistelse finansierades
genom ett stipendium från University of Toronto (UofT) och Toronto Intelligent
Decision Engineering Laboratory (TIDEL). Under min forskning blev jag mycket
intresserad av operations research, optimering och att lösa NP-svåra
kombinatoriska problem med hjälp av distribuerade algoritmer. Tillsammans med
en annan doktorand publicerade vi en artikel\cite{DuaGab2007}, och hela
utlandserfarenheten gav mig vänner för livet, fördjupade mitt analytiska
tänkande och breddade mina kunskaper inom forskning och mjukvaruutveckling.
    \begin{itemize}
    \item Forskning inom artificiell intelligens och planering. Publicerad artikel: ”Modelling Security Protocol Synthesis with AI Planning”, UofT TIDEL, ON, Kanada.
    \item Forskning inom optimering, parallella och distribuerade algoritmer samt kommunikationsprotokoll. Publicerad artikel: ”Solving Combinatorial Problems with Parallel Cooperative Solvers”, Ninth International Workshop on Distributed Constraint Reasoning, Brown University, Providence, Rhode Island, USA.
    \item Installera och konfiguera ett stort MPI (Message Passing Interface) kluster i labbet.
    \item Utveckling av Tabu search algoritmen som ett MPI program för klusterberäkning.
    \end{itemize}
}
\bigskip
...
{Ansvara för 600 registrerade medlemmar.}
\cventry{2004--2005}{Kassör}{Lule\aa \ University Academic Computer Society}{City}{Lule\aa}
{Ansvara för ekonomin med en budget på över 180 000 SEK. Hantera inkomster och utgifter, sköta bokföringen, betala fakturor och upprätta årsredovisning}
\bigskip
...
\cvskillentry*{DevOps/Tools:}
               {5}{Ansible}{3}{Använt för zero-touch-automation tillsammans med Jinja2, YAML och Redfish.}
...
\cvskillentry{}{5}{Git}{13}{Använder det konstant hemma och på alla uppdrag.}
...
\cvskillentry{}{5}{Vim}{20}{Mitt huvudsakliga textredigeringsverktyg för programmering och redigering.}
