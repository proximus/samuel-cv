...
6494.
    ...
    \item Utvecklingsverktyg: C/C++, Java Yocto, Git, Gerrit, Jenkins, Jira och NeoVim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
sikt och säkerhet.
    ...
    \item Utvecklingsverktyg: C/C++, Python, Bash, Yocto, Devtool, Jira, Git, BitBucket, Jenkins och NeoVim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
Shared-DPD.
    ...
    \item Utvecklingsverktyg: C, MATLAB, Yocto, Git, Xilinx SDK, GDB och Vim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
NIC-latens.
    ...
    \item Utvecklingsverktyg: C/C++, Assembler, MATLAB, Python, Ansible, YAML, Bash, Git, Jenkins and Vim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
batterisystem som kommunicerar med varandra genom Bluetooth.
    ...
    \item Utvecklingsverktyg: Python, Tcl/Expect, Bash, Git, Gerrit, Jenkins och Vim.
    \end{itemize}
...
produkten E100 centralenhet som baseras på AT91SAM9x5-EK MCU.
    ...
    \item Utvecklingsverktyg: C, Bash, Buildroot, Git och Vim.
    \end{itemize}
\end{itemize}
}
\bigskip
...
därefter utveckla drivrutinerna tills de fysiska korten anländer från fabriken.
    ...
    \item Utvecklingsverktyg: C/C++, Green Hills Hardware Debugger Probe, Ruby, Tcl/Ecpect, Python, Bash, Git, Gerrit, Jenkins och Vim.
    \end{itemize}
}
\bigskip
...
Classic-runtime-miljön för PLEX-baserade system såsom AXE.
    ...
    \item Utvecklingsverktyg: C, Python, Perl, Tcl/Expect, YAML, Bash, Git, Gerrit and Vim. 
    \end{itemize}
\end{itemize}
}
\bigskip
